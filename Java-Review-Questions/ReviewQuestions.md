...
12. Internal working of Synchronization?
13. In which areas is the lock concept applicable?
14. What is a race condition?
15. How can the threads communicate with each other?
16. What is Deadlock?
17. Differentiate between Deadlock and Starvation?
18. How can we convert a normal thread into a daemon thread?
19. What is a thread pool?
20. Do you know reentrant locks?





1. How to create a custom checked exception
2. How do you handle exceptions?
3. What is Normalization
4. What is the Singleton Design Pattern?
5. When should we use TreeMap instead of HashMap?
6. Diff between Thread, Runnable, and Callable
...
11. Serialisation and deserialization?
12. Fail safe vs failFast?
13. Wait vs notify vs notifyAll?
...
10. How to detect memory leaks in Java?  - scenario for memory leak and how to fix
11.  What is the difference between stateful and stateless session beans?  scenario to use
12. 